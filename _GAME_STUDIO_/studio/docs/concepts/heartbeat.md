...
A periodic execution system that triggers automated tasks.
...
- Python heartbeats for simple, deterministic work (saves tokens)
- Agent heartbeats for tasks requiring reasoning
- All heartbeats logged to Data Accumulation
- Heartbeats can create Tasks (routed through CEO)

## Relationships

- Creates **Tasks** via task_manager
- Tasks assigned to **Agents** per template
- **BOSS** reviews completed heartbeat tasks
